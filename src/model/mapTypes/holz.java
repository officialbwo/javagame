...
public class holz extends map{

	private int dach 	= 0x804000;
	private	int wand	= 0x331A00;
	...
	public holz(int position, int indicator, int color, int posX, int posY, int tileWidth) {
